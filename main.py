...
⣿⣿⣿⡇⠈⠻⠿⠿⠟⣻⣿⣆⠀⠀⠀⣿⣿⣿⣿⠀⠘⠋⢀⣼⣿⠀⠘⠛⠛⣿⣿⠀⣿⣿⣿⣿⡇⠀⣿⣿⠀⣿⣷⡄⢀⣿⡇⠈⠛⠛⣻⣿⠀⠘⠛⢀⣼⣿⣿⣿
⣿⣿⣿⡇⠀⠀⠀⠀⣠⣿⣿⡿⠀⠀⣰⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿
⣿⣿⣿⣧⣤⣤⣴⣾⣿⣿⣿⣧⣶⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿{Style.RESET_ALL}{Fore.LIGHTYELLOW_EX + Style.BRIGHT}Code By Arch0ns{Style.RESET_ALL}{Fore.LIGHTCYAN_EX + Style.BRIGHT}⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿
⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿⠿
{Style.RESET_ALL}""") 
    print(f"{Fore.LIGHTBLUE_EX + Style.BRIGHT}🚀 DePINed Bot! t.me/archdrop{Style.RESET_ALL}")
